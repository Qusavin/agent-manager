...
![the mouse in the list: the wheel moves the cursor, a click selects a row, a double click focuses it, a click on the list comes back, the divider drags, and a click on the messages card opens it](demo-mouse.gif)
